...
import uploadImg from '../../assets/img/projetos/proj-cursinho.png'
      ...
      <div className="center px-0">
        ...
        >
          ...
          <CardProj
            imgProj={uploadImg}
            titleProj="Cursinho"
            description="Projeto de um site de cursinho preparatório"
          ...
          <CardProj
            ...
            href="https://guixavier77.github.io/gxsystem-landing/"
            github="https://github.com/guixavier77/cursinho-landingpage"
          ></CardProj>
        </div>
      </div>
    </section>
